...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.myParent.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("schools.my-parents.store") }}" enctype="multipart/form-data">
            @csrf 
            ...
            <div class="row">
                ...
                <div class="col-md-12" id="driver-relation" style="display:none">
                    <div class="row">
                        <div class="form-group col-md-6">
