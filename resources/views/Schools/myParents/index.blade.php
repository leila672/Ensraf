...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('schools.my-parents.create') }}">
                            ...
                            <tr data-entry-id="{{ $myParent->id }}">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('schools.my-parents.show', $myParent->id) }}">
                                        {{ trans('global.view') }}
                                    </a>

                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('schools.my-parents.edit', $myParent->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>

                                    <form action="{{ route('schools.my-parents.destroy', $myParent->id) }}" method="POST"
    ...
    <script>
        $(function() {
            let dtButtons = $.extend(true, [], $.fn.dataTable.defaults.buttons)
                ...
                url: "{{ route('schools.my-parents.massDestroy') }}",
            ...
            let table = $('.datatable-MyParent:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
