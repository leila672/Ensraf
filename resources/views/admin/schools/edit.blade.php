                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text"
                                name="last_name" id="last_name" value="{{ old('last_name', $school->user->last_name) }}"
                                required>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('area') ? 'is-invalid' : '' }}" type="text" name="area"
                            id="area" value="{{ old('area', $school->area) }}" required>
                        @if ($errors->has('area'))
                            <div class="invalid-feedback">
                                {{ $errors->first('area') }}
                            </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text"
                            name="sector" id="sector" value="{{ old('sector', $school->sector) }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('classificaion') ? 'is-invalid' : '' }}" type="text"
                            name="classificaion" id="classificaion"
                            value="{{ old('classificaion', $school->classificaion) }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control timepicker {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text"
                            name="end_time" id="end_time" value="{{ old('end_time', $school->end_time) }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}"
                            ...
                            value="{{ old('start_time', $school->start_time) }}" required>
